...
The built-in intent reference contains the following information about each built-in intent:

- Description and usage guidance
- Locales available for creating previews in the[App Actions test tool](https://developer.android.com/guide/app-actions/test-tool)
- Locales available for app users to trigger App Actions using the BII (based on the user's device and Assistant language settings)
- Example Assistant queries
- Supported built-in intent parameters and values
- Availability of inventory by intent parameter
